...
parser.add_argument('--epochs', type=int, default=45, help='number of epochs for training')
...
parser.add_argument('--dataset_path', type=str, default='avenue', help='directory of data')
